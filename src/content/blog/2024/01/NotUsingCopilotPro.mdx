...
the power of generative AI to their ubiquitous Office suite. It looks incredible and should be a big
productivity boost for people who use these products regularly. For many people, this new technology is going to be a
game-changer. Here's why I won't be using it for the foreseeable future.
...
I spend a lot on AI. I justify this investment with the amount of productivity I get out of it, which is far, far more
than I spend on it. I'm not yet at the triple digit amount, but I expect that may happen someday. A lot of that money is
already going to Microsoft in [one form](https://openai.com/blog/chatgpt) or [another](https://github.com/features/copilot).
...
*The Copilot logo is a visual representation of the Microsoft ecosystem
vendor-lock [Ouroboros](https://en.wikipedia.org/wiki/Ouroboros)*
...
UPDATE: Minutes after bringing this blog post live, my invite to the JetBrains GitHub Copilot Chat beta arrived. 
The AI is listening. 👀
...
any of Microsoft's file formats, Markdown is portable, readable plain text. Markdown does much of what most people
...
As a long time user of [Obsidian](https://obsidian.md/) I certainly have some opinions on what Markdown editor works
best for my life, where I like to keep my generated content, and how I like to organize it. Since ChatGPT "speaks" Markdown natively, it's easy
...
[Text Generator](https://text-gen.com/) plugin.
...
the things in this demo I actually care about. Much like Obsidian can do much of what most people need out of Word, 
Text Generator can do much of what people need out of Copilot Pro.
...
between these two programs is something I won't be able to do justice, so you should definitely try it for yourself.
...
near $20/month. This is especially true with the newer, less expensive GPT4 model. Paradoxically, some of the best user
experiences using AI are free and open source implementations, as products built around a paid AI service have every 
incentive to be as obnoxious as possible to get your subscription.

Since you're saving on your AI bill, you should [buy a coffee, or several](https://www.buymeacoffee.com/haouarine), for the creator of Text Generator.
...
[PlantUML](https://plantuml.com/), and, increasingly, [Slidev](https://sli.dev/).
I love️ documentation tools like [Docusaurus](https://docusaurus.io/) and [Starlight](https://starlight.astro.build/)
which allow me to keep my documentation in plain text. The other critical component of my plain text stack is [Git](https://git-scm.com/), 
which can perform magic spells when given the right plain text invocations.
